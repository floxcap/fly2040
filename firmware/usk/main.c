...
void self_test()
{
    ...
    if(!rst_ok)
    {
        finish_with_code(0, 2);
    }
    if(!cmd_ok)
    {
        finish_with_code(1, 2);
    }
    if(!d0_ok)
    {
        finish_with_code(2, 2);
    }
}
